    ...
    render() {
        ...
        <div class="glass-pane border-b border-white/5 pt-12 pb-3 px-4 sticky top-0 z-20  bg-[#1a1b22]/90">
            <div class="flex justify-between items-center mb-3">
                <div>
                    <h1 class="text-2xl md:text-3xl font-black chrome-text">VirMusic</h1>
            ...
            <div class="glass-strong rounded-3xl p-5 border border-white/15 bg-gradient-to-br from-white/10 via-white/5 to-transparent relative overflow-hidden ">
                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-left relative z-10">
                    ...
                    <div class="flex-1">
                        ...
                        <h2 class="text-2xl font-black text-white">Vir</h2>
                        <p class="text-xs text-[#b3b3b3] mt-1 leading-relaxed">Pengembang & Pembuat VirMusic. Selamat menikmati streaming musik favorit tanpa gangguan!</p>
                        <div class="flex flex-wrap items-center gap-2 mt-3.5 justify-center sm:justify-start">
                            <a href="https://whatsapp.com/channel/0029Vb8IZxaFHWqAJe7pld1N" target="_blank" class="btn-chrome px-3.5 py-1.5 rounded-full text-xs font-bold flex items-center gap-1.5 shadow-md active:scale-95 transition-all">
                                💬 Channel WA
                            </a>
